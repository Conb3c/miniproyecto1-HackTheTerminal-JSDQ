...
public interface IValidateWord {
    ...
    /**
     * Validates if the user's input matches the current word.
     *
     ...
     */
    boolean validateWord(String currentWord, String userInput);
     ...
     */
    char[] decompouseWord(WordBank wordToValidate, String word);
}
